...
class TransformerVAE(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(d_model, d_model)  # mu
        self.fc2 = nn.Linear(d_model, h_dim)  # log_var
        self.fc3 = nn.Linear(d_model, h_dim)
        # 解码器 ： [b, z_dim] => [b, input_dim]
        self.fc4 = nn.Linear(h_dim, d_model)
        self.fc5 = nn.Linear(d_model, self.output_dim)
