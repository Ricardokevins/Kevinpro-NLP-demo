...
# Follow Implement http://nlp.seas.harvard.edu/2018/04/03/attention.html
...
class TransformerVAE(nn.Module):
    ...
    def trans_encode(self, src, src_mask):
        return self.encoder(self.src_embed(src), src_mask)
    ...
    def forward(self, src, tgt):
        ...
        enc_outputs = self.trans_encode(src, src_mask)
        mu, log_var = self.encode(enc_outputs)
        sampled_z = self.reparameterization(mu, log_var)
        x_hat = self.decode(tgt,src,sampled_z)
